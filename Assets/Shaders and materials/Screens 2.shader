...
Shader "Screens 2"
{
	...
	SubShader
	{
		...
		{
			float4 color4 = IsGammaSpace() ? float4(0,0.990099,1,0) : float4(0,0.9776244,1,0);
			o.Albedo = color4.rgb;
...
/*ASEBEGIN
Version=18900
0;568;1324;418;1505.084;350.1297;1.938335;True;True
...
Node;AmplifyShaderEditor.ColorNode;4;-341.4951,-89.49062;Inherit;False;Constant;_Color2;Color 0;2;0;Create;True;0;0;0;False;0;False;0,0.990099,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=810694EF52F1D948FB61A734500609E9D9BED1B4