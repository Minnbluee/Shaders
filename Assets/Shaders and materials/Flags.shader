...
Shader "Flags"
{
	...
	SubShader
	{
		...
		{
			float4 color7 = IsGammaSpace() ? float4(0.6273585,1,0.9185483,0) : float4(0.3514183,1,0.8246167,0);
			o.Albedo = color7.rgb;
...
/*ASEBEGIN
Version=18900
0;568;1324;418;1330.669;381.0538;1.432206;True;True
...
Node;AmplifyShaderEditor.ColorNode;7;-326.692,-259.3161;Inherit;False;Constant;_Color0;Color 0;3;0;Create;True;0;0;0;False;0;False;0.6273585,1,0.9185483,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=EFFD6D37EA43F096FB319D78E4B0E7B205B48606